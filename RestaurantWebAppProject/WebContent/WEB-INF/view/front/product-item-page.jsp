                            ...
                            <c:forEach var="related" items="${related }">
                                <div class="col-12 col-sm-6 col-md-3">
                                    <article class="productItem">
                                        <figure><a href="product-item-page?id=${related.id }"><img src="${related.image }" class="img-responsive center-block" alt="img shop"/></a></figure>
                                        <h4><a href="product-item-page?id=${related.id }">${related.name }</a></h4>
                                        <p>${related.price }</p>
