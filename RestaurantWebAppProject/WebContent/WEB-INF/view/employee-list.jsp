             ...
             <c:forEach var="employee" items="${employeeList }">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <img src="<%= request.getContextPath() %>/${employee.image }" style="max-width: 80px;">
                      </td>

                      <td class="text-center">
                        <div class="btn-group">
                          <a href="form-employee-update?id=${employee.id }" class="btn btn-info">
					      ...
					      <div class="modal-dialog">
					        <div class="modal-content">
					          ...
					          <div class="modal-footer justify-content-between">
					            ...
					            <a href="form-employee-delete?id=${employee.id }" class="btn btn-danger">Delete</a>
					          </div>
					        </div>
					        <!-- /.modal-content -->
					      </div>
