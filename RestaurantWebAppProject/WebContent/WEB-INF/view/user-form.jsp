                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label>Name</label>
                        <form:textarea path="name" class="form-control" placeholder="Enter name"/>
                        <form:errors path="name" cssClass="text-danger"/>
                      </div>
                       <div class="form-group">
                        <label>Surname</label>
                        <form:textarea path="surname" class="form-control" placeholder="Enter surname"/>
                      ...
                      <div class="form-group">
                        ...
                        <form:select path="authorities" items="${roles }" itemLabel="authority" itemValue="authority" multiple="true" class="form-control"></form:select>
                      </div>
